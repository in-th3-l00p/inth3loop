import logo from '@/images/clients/sigloop/logomark-dark.svg'
...
export const caseStudy = {
  ...
  image: { src: imageHero },
  date: '2025-06',
  service: 'smart contracts, SDK, web3',
  testimonial: {
...
>
  ...
  autonomously, but they should never have unchecked access to funds. we built
  the guardrails that make agent payments safe.
</Blockquote>
